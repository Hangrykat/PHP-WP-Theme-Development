(function ($) {
  ...
  $.fn.vids = function (options) {
    ...
    if (!document.getElementById("vids-style")) {
      ...
      var css =
        ".video-wrap{width:100%;position:relative;padding:0}.video-wrap iframe, .video-wrap object, .video-wrap embed{position:absolute;top:0;left:0;width:100%;height:100%}";
