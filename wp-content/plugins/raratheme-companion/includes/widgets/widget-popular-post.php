                        ...
                        <?php if( $show_thumb ){ 
                                if( has_post_thumbnail() ){
                                    ...
                                    <a <?php echo $target;?> href="<?php the_permalink();?>" class="post-thumbnail">
                                        <?php
                                        $rttk_popular_post_size = 'style-one' === $instance['style'] ? apply_filters('rara_popular_post_size','thumbnail') : apply_filters('rara_popular_post_size','post-slider-thumb-size');
